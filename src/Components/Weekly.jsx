  ...
  return (
    <div className="container  mx-auto mt-10 ">
      <div className="grid gap-4 md:grid-cols-12 lg:grid-cols-12 md:gap-5 px-10 md:px-10 lg:px-5 ">
        {/* grid 1 */}
        <div className="col-span-8 me-10 md:me-0 lg:me-0  md:col-span-4 lg:col-span-4 border border-slate-200 px-4 shadow-md">
          {/* grid 1 header */}
        ...
        {/* grid 2  */}
        <div className="col-span-8  border border-slate-200 pe-10 md:pe-0 lg:pe-0 shadow-md">
          {/* grid 2 foot header */}
          <div className="flex mt-5 mb-6 px-4 items-center justify-between">
            <div>
              <h1 className="font-bold  text-lg tracking-wide">Top Projects</h1>
                ...
                <tr className="border-b bg-white">
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      />
                      <div className="flex-wrap leading-6 items-center justify-center">
                        <h1 className="font-bold text-gray-900">Sunil Joshi</h1>
                        <h2 className="text-[13px] text-gray-500 tracking-normal">
                          Web Designer
                        </h2>
                      </div>
                  ...
                  <td className=" ps-14 md:ps-14lg:-px-6 py-4"> Elite Admin</td>
                ...
                <tr className=" bg-white">
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      />
                      <div className="flex-wrap  block leading-6 items-center justify-center">
                        <h1 className="font-bold text-gray-900">Nirav Joshi</h1>
                        <h2 className="text-[13px] text-gray-500 tracking-normal">
                          Frontend Engineer
                        </h2>
                      </div>
