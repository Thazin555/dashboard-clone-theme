  ...
  return (
    <div className="block lg:grid grid-cols-12 gap-10 mb-10">
      ...
      <div className="w-full block overflow-x-scroll lg:overflow-hidden lg:col-span-4">
        <div className="px-5 pt-7 py-3 border rounded-md">
          <h1 className="text-xl text-gray-700 font-semibold">Payment Gateways</h1>
          <h3 className="text-gray-700 font-normal text-sm">
          Platform For Income
          </h3>
            ...
            <div className=" pt-4  overflow-x-auto">
              <div className="inline-block min-w-full overflow-hidden">
                <table className="min-w-full leading-normal">
                  ...
                  <tbody>
                    <tr className="">
                      <td className=" py-6 text-sm bg-white border-b border-gray-200">
                        <div className="flex items-center">
                          <div className="flex-shrink-0">
                            <a href="#" className="relative block bg-[#e4f2fa] p-2 rounded-md">
                              <img
                                alt="profile"
                    ...
                    <tr className="">
                      <td className=" py-6 text-sm bg-white border-b border-gray-200">
                        <div className="flex items-center">
                          <div className="flex-shrink-0">
                            <a href="#" className="relative block bg-[#e3f1f9] p-2 rounded-md">
                              <img
                                alt="profile"
                    ...
                    <tr className="">
                      <td className=" py-6 text-sm bg-white border-b border-gray-200">
                        <div className="flex items-center">
                          <div className="flex-shrink-0">
                            <a href="#" className="relative block bg-[#fef5e6] p-2 rounded-md">
                              <img
                                alt="profile"
                      ...
                      <td className=" py-6 text-sm bg-white border-b border-gray-200">
                        <p className="text-gray-500 whitespace-no-wrap">+$2235</p>
                      </td>

                      
                    </tr>
                    <tr className="">
                      <td className=" py-6 text-sm bg-white">
                        <div className="flex items-center">
                          <div className="flex-shrink-0">
                            <a href="#" className="relative block bg-[#fae6e0] p-2 rounded-md">
                              <img
                                alt="profile"
